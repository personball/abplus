...
NuGet "pack" "..\src\Abplus.Events.Producer\Abplus.Events.Producer.csproj" -Properties Configuration=Release
NuGet "pack" "..\src\Abplus.RebusRabbitmqConsumer\Abplus.RebusRabbitmqConsumer.csproj" -Properties Configuration=Release
NuGet "pack" "..\src\Abplus.RebusRabbitmqProducer\Abplus.RebusRabbitmqProducer.csproj" -Properties Configuration=Release
...
NuGet "pack" "..\src\Abplus.MqMessages.RebusConsumer\Abplus.MqMessages.RebusRabbitMqConsumer.csproj" -Properties Configuration=Release
